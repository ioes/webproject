<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ErrorQue.aspx.cs" Inherits="WebWork.ErrorQue" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="border-style: double; border-color: #000000; font-size: large;">
        <br />
        <asp:TreeView ID="TreeView1" runat="server" BackColor="#CCFFFF" ForeColor="Black" Width="250px" ImageSet="BulletedList3" ShowExpandCollapse="False" BorderColor="#99FFCC" BorderStyle="Solid" Height="136px">
                                ...
                                <table align="center" border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("Answer") %>'  ForeColor="Red"></asp:Label>
                                            <br />
                                        <asp:Label ID="Label16" runat="server" Text="你错选的答案是："></asp:Label>
                                        <asp:Label ID="Label17" runat="server" Text='<%# Eval("str") %>'></asp:Label>
                                            </td>
                                    </tr>
                                </table>
                            </ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                ...
                                                <br />
                                                <asp:Label ID="Label18" runat="server" Text="你错选的答案是："></asp:Label>
                                                <asp:Label ID="Label19" runat="server" Text='<%# Eval("str") %>'></asp:Label>
                                            </td>
                                        </tr>
                                    </tr>
                                </table>
